...
const TimeIcon = ({height, width, fill, stroke }: IconProps) => {
    return (<svg fill={fill || "currentColor"} width={width} height={height} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
